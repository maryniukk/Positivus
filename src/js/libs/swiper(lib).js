                ...
                if (null != e && e && (!e || e.params) && !e.destroyed) {
                  if (
                    ...
                    if (r.hasClass(e.params.slideDuplicateClass)) {
                      l(
                        e.$wrapperEl.children(`[data-swiper-slide-index="${t}"]:not(.${e.params.slideDuplicateClass})`).index(),
                        !1,
                      )
                    } else {
      ...
      t({ cubeEffect: { slideShadows: !0, shadow: !0, shadowOffset: 20, shadowScale: 0.94 } }),
        F({
          ...
          setTranslate: () => {
            ...
            if (
              (s.css({ '-webkit-transform-origin': `50% 50% -${l / 2}px`, 'transform-origin': `50% 50% -${l / 2}px` }), c.shadow)
            )
              if (p)
                h.transform(
